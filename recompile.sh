...
java -jar smali/smali/build/libs/smali.jar a -a 34 classes4 -o framework/classes4.dex
java -jar smali/smali/build/libs/smali.jar a -a 34 classes5 -o framework/classes5.dex
